...
/*!
  ...
  @brief Definition of the Direct_Product_Mesh_v1 class.

  A Direct_Product_Mesh_v1 is a basic, serial, 1/2/3D, axis-aligned,
...
/*!
  @class Direct_Product_Mesh_v1 "direct_product_mesh.h"
  @brief A basic, axis-aligned, logically-rectangular mesh.

  A Direct_Product_Mesh_v1 is a basic, serial, 1D/2D/3D, axis-aliged,
  logically-rectangular mesh.  It is called a direct product mesh because it is
  the direct product of independent discretizations along each axis.
  ...
  The Direct_Product_Mesh_v1 is designed to implement only the necessary
  ...
  Direct_Product_Mesh_v1 may also expand.
 */
class Direct_Product_Mesh_v1 {
 ...
 public:
  ...
  Direct_Product_Mesh_v1() = delete;

  /*!
    @brief Constructor to create a 1D Direct_Product_Mesh_v1.
    @param[in] edges The cell edge coordinates.

    Specify the edge coordinates that delineate the cells of the mesh.
  */
  Direct_Product_Mesh_v1(std::vector<double> edges);

  /*!
    @brief Constructor to create a 2D Direct_Product_Mesh_v1.
    ...
    each axis.
  */
  Direct_Product_Mesh_v1(std::vector<double> edges_i,
                      std::vector<double> edges_j);

  /*!
    @brief Constructor to create a 3D Direct_Product_Mesh_v1.
    @param[in] edges_i The cell edge coordinates along the first axis.
    @param[in] edges_j The cell edge coordinates along the second axis.
  ...
  */
  ...
  Direct_Product_Mesh_v1 & operator=(const Direct_Product_Mesh_v1 &) = delete;

  //! Destructor
  ~Direct_Product_Mesh_v1();
...
Direct_Product_Mesh_v1::Direct_Product_Mesh_v1(
...
int Direct_Product_Mesh_v1::space_dimension() const {
  return dimensionality_;
}

// ____________________________________________________________________________
// Get the number of points (edge coordinates).
int Direct_Product_Mesh_v1::axis_num_points(const int dim) const {
  return edges_[dim].size();
}

// ____________________________________________________________________________
// Get the specified point (edge coordinate).
double Direct_Product_Mesh_v1::axis_point_coordinate(
...
// ============================================================================
// Private support methods
void Direct_Product_Mesh_v1::set_default_coordinates() {
