...
TEST(StructPartitioner, Serial) {

  {
    ...
    std::array<std::array<std::array<int, 2>, 2>, 4> exp_partlimits =
...

  {
    ...
    std::array<std::array<std::array<int, 2>, 2>, 3> exp_partlimits =
...

  {
    ...
    std::array<std::array<std::array<int, 3>, 2>, 8> exp_partlimits =
...

  {
    ...
    std::array<std::array<std::array<int, 3>, 2>, 5> exp_partlimits =
