...
#cmake_policy(SET CMP0079 NEW)  # allow adding to target property
...
if (Jali_DIR AND NOT Jali_LIBRARIES)
   ...
   target_include_directories(wonton PUBLIC ${Jali_INCLUDE_DIRS} ${Jali_TPL_INCLUDE_DIRS})
   target_link_libraries(wonton PUBLIC ${Jali_LIBRARIES})
...
#
# If we cannot use CMake 3.13 or higher we have to use include instead of
# add_subdirectory (because we are not able to add to targets from another
# subdirectory in earlier versions)
#-----------------------------------------------------------------------------

# include(wonton/CMakeLists.txt)
