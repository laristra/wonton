...
TEST_F(SwarmTest, Check_1D_random) {
  ...
  Wonton::Swarm<1> swarm(n, random, no_seed, p_min, p_max);
...
TEST_F(SwarmTest, Check_1D_random_seed) {
  ...
  Wonton::Swarm<1> orig(n, random, seed, p_min, p_max);
  Wonton::Swarm<1> twin(n, random, seed, p_min, p_max);
...
TEST_F(SwarmTest, Check_2D_random) {
  ...
  Wonton::Swarm<2> swarm(n * n, random, no_seed, p_min, p_max, p_min, p_max);
...
TEST_F(SwarmTest, Check_2D_random_seed) {
  ...
  Wonton::Swarm<2> orig(n * n, random, seed, p_min, p_max, p_min, p_max);
  Wonton::Swarm<2> twin(n * n, random, seed, p_min, p_max, p_min, p_max);
...
TEST_F(SwarmTest, Check_3D_random) {
  ...
  Wonton::Swarm<3> swarm(n * n * n, random, no_seed, p_min, p_max, p_min, p_max, p_max, p_max);
...
TEST_F(SwarmTest, Check_3D_random_seed) {
  ...
  Wonton::Swarm<3> orig(n * n * n, random, seed, p_min, p_max, p_min, p_max, p_max, p_max);
  Wonton::Swarm<3> twin(n * n * n, random, seed, p_min, p_max, p_min, p_max, p_max, p_max);
...
TEST_F(SwarmTest, Check_1D_regular) {
  ...
  Wonton::Swarm<1> swarm(n, regular, no_seed, p_min, p_max);
...
TEST_F(SwarmTest, Check_2D_regular) {
  ...
  Wonton::Swarm<2> swarm(n * n, regular, no_seed, p_min, p_max, p_min, p_max);
...
TEST_F(SwarmTest, Check_3D_regular) {
  ...
  Wonton::Swarm<3> swarm(n * n * n, regular, no_seed, p_min, p_max, p_min, p_max, p_min, p_max);
...
TEST_F(SwarmTest, Check_1D_perturbed) {
  ...
  Wonton::Swarm<1> swarm(n, perturbed, no_seed, p_min, p_max);
...
TEST_F(SwarmTest, Check_2D_perturbed) {
  ...
  Wonton::Swarm<3> swarm(n * n, perturbed, no_seed, p_min, p_max, p_min, p_max);
...
TEST_F(SwarmTest, Check_3D_perturbed) {
  ...
  Wonton::Swarm<3> swarm(n * n * n, perturbed, no_seed, p_min, p_max, p_min, p_max, p_min, p_max);
...
TEST_F(SwarmTest, Check_3D_perturbed_seed) {
  ...
  Wonton::Swarm<3> orig(n * n * n, perturbed, seed, p_min, p_max, p_min, p_max, p_min, p_max);
  Wonton::Swarm<3> twin(n * n * n, perturbed, seed, p_min, p_max, p_min, p_max, p_min, p_max);
...
TEST_F(SwarmTest, Build_Simple_Mesh_Wrapper_Cell) {
  ...
  Wonton::Swarm<3> swarm(mesh, Wonton::CELL);
...
TEST_F(SwarmTest, Build_Simple_Mesh_Wrapper_Node) {
  ...
  // create particle field from generated mesh
  Wonton::Swarm<3> swarm(mesh, Wonton::NODE);
...
TEST_F(SwarmTest, Multiple_2D) {
  ...
  Wonton::Swarm<2> swarm(wrappers, Wonton::NODE);
...
TEST_F(SwarmTest, Multiple_3D) {
  ...
  // create particle field from list of meshes
  Wonton::Swarm<3> swarm(wrappers, Wonton::NODE);
